...
def analyze(cube):
    ...
    if array_equal(
        cube.stickers[2:, :, 0:2], cube.stickers_solved[2:, :, 0:2]
    ) and array_equal(cube.stickers[1], cube.stickers_solved[1]):
        ll_flag = True
        if array_equal(cube.stickers[0], cube.stickers_solved[0]):
            ...
            cube.stickers[0, 1], cube.stickers_solved[0, 1]
        ) and array_equal(cube.stickers[0, 1, :], cube.stickers_solved[0, 1, :]):
        ...
        ll_flag, pll_flag, oll_flag, coll_flag, ell_flag = (
            False,
            False,
            False,
            False,
